...
# selecting top 5 city vote counts
city_votes = df['City'].value_counts().head(5).reset_index()
...
# selecting top 5 cuisines vote counts
city_votes = df['Cuisines'].value_counts().head(5).reset_index()
